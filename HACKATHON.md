...
| **V3** | **DEPLOYED, verified, and SETTLED on Ethereum Sepolia**, hook `0x5d6AdF56facB123A2e46D36EA7034cb393D6A0c0`. `receiptCount()` is **1** as of 2026-09-10: 0.001 ETH in, 2.216294 USDC out, tx `0x4f4acbd1…8854`, block 11675187. On the other three chains — Unichain, Base and Arbitrum Sepolia — it is deployed and verified and `receiptCount()` is still **0** |
