...
label='pool ?id|salt|hash|keccak|sha-?256|tx|transaction|block|bytes32|id"?[[:space:]:]|[nN]ode"?[[:space:]:]|swap|receipt|topic|digest|witness|domain|vector|curve|signature|resource|roles|token ?id'
