...
gate     : _need-deps
	...
	forge build && forge test --no-match-path '{test/fork/*,test/compat/*,test/anvil/*,test/v3/DeploymentsV3Fork.t.sol,test/v3/LiveFireV3Fork.t.sol}' && forge fmt --check
	bash script/scan.sh
...
NET ?= sepolia_testnet
business-live:
	bash script/business/live.sh $(NET)
v5-preflight v5-mint v5-A v5-readback v5-B v5-C v5-D v5-activate v5-manifest v5-verify v5-evidence v5-commit v5-ens-records v5-ens-lineage:
